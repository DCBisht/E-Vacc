      ...
      <section className="footer">
        <div className="box-container">
          ...
          <div className="box">
            ...
            <a href="#">
              {" "}
              <i className="fas fa-phone"></i> +123-456-7859
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-phone"></i> +356-481-0286
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-envelope"></i> EVacc.info.com
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-envelope"></i> EVacc.@gmail.com
            </a>
            <a href="#">
              {" "}
              <i className="fas fa-map-marker-alt"></i> Bhopal,India - 1000
            </a>
          </div>
          <div className="box">
            <h3>follow us</h3>
        ...
        <div className="credit">
          created by <span>Group 102</span> | all right reserved
        </div>
      </section>
    </div>
  );
